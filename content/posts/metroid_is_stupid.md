...
This means that I will frequently have to just run a round pressing random
buttons, which on its own is annoying, but combined with the fact that all
enemies respawn when I leave and reenter a room it becomes pretty unfun. The
enemies are not hard to fight, and you encounter them often enough that the way
to fight each of them becomes very obvious and easy. But it does take time every
single time. All the combat does is slow you down. It's repetitive enough for
you to not want to do it for its own sake, and you don't gain any resources from
it except the health and missiles you depleted by engaging in it in the first
place. 
